...
import os
#os.environ['PROJ_LIB'] = 'C:/Users/Admin/AppData/Local/Programs/Python/Python312/Lib/site-packages/pyproj/proj_dir/share/proj'
#os.environ['GDAL_DATA'] = 'C:/Users/Admin/AppData/Local/Programs/Python/Python312/Lib/site-packages/rasterio/gdal_data'
...
from krig2 import QtSelectFiles, CompleteDataWindow, DataFrameModel, DataFrameDisplayWindow
...
if hasattr(sys, '_MEIPASS'):
    ...
    os.environ['PROJ_DATA']=pyproj.datadir.get_data_dir()
    os.environ['GDAL_DATA']=os.path.join(os.getenv('CONDA_PREFIX',''),'Library','share','gdal')
...
if '_PYIBoot_SPLASH' in os.environ:
    try:
        import pyi_splash
        pyi_splash.update_text('Opening KrigMapPro')  # Optional: update splash text
        pyi_splash.close()  # Immediately close the splash screen
    except:
        pass
class ExcelLoaderApp(QtWidgets.QMainWindow):
    ...
    def __init__(self):
        ...
        if hasattr(sys, '_MEIPASS'):
            ui_file_path = os.path.join(sys._MEIPASS, "krigmap_pro.ui")
        else:
            ui_file_path = os.path.join(os.path.dirname(__file__), "krigmap_pro.ui")
        uic.loadUi(ui_file_path, self)
            ...
            #proj_data_path = os.path.join(base_path, 'proj.db')
        #else:
    ...
    def loadDataIntoTable(self, data):
        ...
        if isinstance(data, pd.DataFrame):
            ...
            # Ensure that NaN values in the DataFrame are replaced with 0.
            data = data.fillna(0)
    ...
    def loadAndDisplayExcel(self):
        ...
        if filePath:
            try:
                ...
                self.df.replace("", 0, inplace=True)  # Replace empty strings with 0
...
##########Plotting and Visualization########
    ...
    def displayVariogram(self, variogram, show_in_spyder=False, normalize=False):
        ...
        self.plot_parameters.append({
            ...
            'fit_sigma': self.widgets['fit_sigma'].currentText() if 'fit_sigma' in self.widgets else 'None',
...
#class ExcelLoaderApp(QtWidgets.QMainWindow):
    ...
    def addBasemap(self, ax):
        ...
        basemap_mapping = {
            ...
            "CartoDB.DarkMatter": xyz.CartoDB.DarkMatter,
...
if __name__ == "__main__":
    ...
    icon = QtGui.QIcon("C:/Users/irish/Downloads/testkrig/krigappicon.ico")  # Use your actual icon path
